...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-6">
				<h1 class="page-header">Promos List</h1>
			</div>
			<div class="col-lg-6">
				<?php echo $this->Html->link('Add Promos',array('action' => 'add'),array('class' => 'btn btn-primary','style' => array('float: right; margin-top: 58px;'))); ?>
			</div>
		</div>
		<!-- /.col-lg-12 -->
	</div>
					...
					<div class="table-responsive1">
						...
						&nbsp;
												...
												if($records->is_feat == 1){
													...
													echo $this->Html->link('Mark as main promo',array('action' => 'feat',$id),array('class' => 'btn btn-info'));
													//echo $this->Html->link('Show on top of page',array('action' => 'feat',$id),array('class' => 'btn btn-info','title' => 'Click to set main promos'));													
												} ?>												
											</td>
										</tr>	
										<?php
