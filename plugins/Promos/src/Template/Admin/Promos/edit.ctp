...
<div id="page-wrapper" style="min-height: 140px;">
	...
	<div class="row">
		<div class="col-lg-6">
			<h1 class="page-header">Update Promos</h1>
		</div>
		<div class="col-lg-6">
			...
			<!--	<div class="col-lg-12">			
				...
				<div class="col-lg-12">			
					<div class="form-group">
						<label>Promos By</label>
						<?php // echo $this->Form->select("promos_user",$promos_user,array('class' => 'form-control'));
						//echo ($lanagauage->is_default == 1) ? $this->Form->error("promos_user") : ''; ?>
					</div>	
				</div>
			-->
