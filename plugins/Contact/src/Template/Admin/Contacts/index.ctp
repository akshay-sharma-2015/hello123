						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-9">
									...
									<div class="col-sm-3">
										<?php echo $this->Form->select("master_id",$department,array('class' =>'form-control','placeholder' => 'Search by Department','empty' => 'Select Department','value' => isset($requestedQuery['master_id']) ? $requestedQuery['master_id'] : '')); ?>
									</div>
									<div class="col-sm-3">
