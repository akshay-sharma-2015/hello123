...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-6">
				<h1 class="page-header">Cms Page Lsit</h1>
			</div>
			<div class="col-lg-6">
				<?php echo $this->Html->link('Add Cms Page',array('action' => 'add'),array('class' => 'btn btn-primary','style' => array('float: right; margin-top: 58px;'))); ?>
			</div>
		</div>
		<!-- /.col-lg-12 -->
	</div>
