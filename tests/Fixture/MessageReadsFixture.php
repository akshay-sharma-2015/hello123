 ...
 *
 */
class MessageReadsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'message_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'message_id' => ['type' => 'unique', 'columns' => ['message_id', 'user_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
